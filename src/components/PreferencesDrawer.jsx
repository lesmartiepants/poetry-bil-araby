        ...
        <>
          ...
          >
            ...
            <div style={{ padding: '8px 24px 16px', textAlign: 'center' }}>
              <h3 style={{ fontFamily: "'Tajawal', sans-serif", color: GOLD, fontSize: '1.1rem', margin: 0, direction: 'rtl' }}>
                تعديل ذوقك
              </h3>
            </div>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '0 16px' }}>
              ...
              <div style={{ marginBottom: '24px' }}>
                <p style={{ fontFamily: "'Tajawal', sans-serif", color: 'rgba(255,255,255,0.5)', fontSize: '0.8rem', marginBottom: '12px', textAlign: 'center', direction: 'rtl' }}>
                  كيف تشعر الآن؟
                </p>
                <MoodPicker
                  onNext={(v) => setMoods(v)}
            ...
            {/* Actions */}
            <div style={{ padding: '16px 24px 32px', display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center' }}>
              <button
                onClick={handleSave}
                style={{
                  width: '100%', maxWidth: 280, padding: '12px',
                  background: `${GOLD}22`, border: `1px solid ${GOLD}`,
                  borderRadius: '999px', color: GOLD,
              ...
              <button
                ...
                style={{
                  ...
                  color: 'rgba(255,100,100,0.6)', fontSize: '0.8rem',
