...
const SplashScreen = ({ isOpen, onDismiss, showOnboarding, theme }) => {
  ...
  // Empty string is intentional — tells React that children are externally managed
  // by the imperative star-generation code above. This is safe (no user input).
  ...
  return (
    <>
      ...
      >
        ...
        {/* Starfield — emptyHtml tells React these children are externally managed */}
        <div
          ref={starsRef}
      ...
      >
        ...
        >
          ...
          {/* Step 1: English letter-by-letter */}
          {kineticStep === 1 && (
            <div
              style={{
                display: 'flex',
