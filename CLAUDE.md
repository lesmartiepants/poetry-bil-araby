...
| ---------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/onboarding`    | `FEATURES.onboardingPrefs` | Account menu → "Set up your feed" / "Change your feed" (label follows saved answers), or debug panel → "Preference Flow". Five preference steps. Deliberately not on the boot path; use `FEATURES.forceOnboarding` if you want it at boot. Reset with `localStorage.removeItem('onboardingPrefs')`. |
