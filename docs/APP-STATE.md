...
_Generated 2026-07-29. **Manifest is in sync with code.**_
...
| `internal-enjoyability-lab` | internal | none | - | Local-only tooling; routes are disabled unless SAVED_CURATION_EMAIL is configured. |
