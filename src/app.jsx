...
export default function DiwanApp() {
  ...
  const pollingIntervals = useRef([]); // Track audio polling intervals for cleanup
  ...
  // handleAnalyze is provided by useInsights hook
  ...
  useEffect(() => {
    // Reset insights state (interpretation, polling intervals)
    resetInsights();
