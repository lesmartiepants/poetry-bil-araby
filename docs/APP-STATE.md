...
_Generated 2026-07-31. **Manifest is in sync with code.**_
...
| `pr-body-probe`          | internal  | behavioral  | -           | Proven via guard-gauntlet (render + mutation break of the probe text).                                                                                                                                    |
